...
<div class="max-w-3xl space-y-6">
    ...
    <div>
        ...
        <h1 class="text-2xl font-bold text-white">Tambah Divisi</h1>
        <p class="text-sm text-slate-400 mt-1">Tambahkan data divisi baru beserta logonya</p>
    </div>

    {{-- Form --}}
    <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 md:p-8">
        <form action="{{ route('admin.divisi.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div>
                <label for="logo" class="block text-sm font-medium text-slate-300 mb-2">Logo Divisi (Opsional)</label>
